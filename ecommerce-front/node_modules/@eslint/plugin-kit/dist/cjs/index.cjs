...
/**
 * @typedef {import("./types.cts").CustomRuleVisitorWithExit<RuleVisitorType>} CustomRuleVisitorWithExit
 * @template {RuleVisitor} RuleVisitorType
 */
/** @typedef {$typests.CustomRuleTypeDefinitions} CustomRuleTypeDefinitions */
/**
 * @typedef {import("./types.cts").CustomRuleDefinitionType<LanguageSpecificOptions, Options>} CustomRuleDefinitionType
