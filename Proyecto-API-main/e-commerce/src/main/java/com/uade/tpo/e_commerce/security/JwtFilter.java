...
public class JwtFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(
        ...
        // Si no hay header o no empieza con Bearer, seguimos al siguiente filtro
        ...
        userEmail = jwtService.extractUsername(jwt); // Este es el getUsername que vimos en el JwtUtil
